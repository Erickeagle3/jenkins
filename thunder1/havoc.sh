...
# curl https://raw.githubusercontent.com/erickeagle3/ThunderServer/master/havoc.sh > script_build.sh
...
export KBUILD_BUILD_USER=Uchiha
export KBUILD_BUILD_HOST=Sharingan
